...
import './favouritesList.css' // добавлен импорт CSS
      ...
      <div className="favourites-grid">
        {favouriteCitiesData.map((data, index) => {
          ...
          return (
            ...
            >
              <h3>{city}</h3>
              <div className="favourite-date">{new Date(dateTime).toLocaleString()}</div>
              <div className="favourite-icon">
                <Icon size={36} />
              </div>
              <div className="favourite-temp black-text">{temp}°C</div>
